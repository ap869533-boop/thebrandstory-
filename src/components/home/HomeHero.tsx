...
export const HomeHero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-black text-white min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-64px-100px)] flex flex-col justify-center py-8 sm:py-16 border-b border-zinc-900 font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4 sm:space-y-8 my-auto">
        {/* 1. Verified Network Badge */}
        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 bg-black text-zinc-300 text-[10px] sm:text-xs font-semibold rounded-full border border-zinc-800 shadow-md whitespace-nowrap">
          ...
          <span className="whitespace-nowrap">India's Biggest Influencer Marketplace • 50,000+ Verified Creators</span>
        </div>
        ...
        <div className="space-y-2 sm:space-y-3 max-w-3xl mx-auto">
          ...
          <p className="text-[11px] sm:text-base text-zinc-300 font-medium max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-4xl sm:max-w-5xl mx-auto bg-black/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-2 sm:p-3.5 shadow-2xl border border-[#D4A338]/40 relative z-30">
          <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row items-center gap-2 sm:gap-2.5 w-full">
            ...
            <div className="relative flex-1 w-full flex items-center bg-zinc-950 rounded-xl sm:rounded-2xl border border-zinc-800 hover:border-zinc-700 transition px-3 sm:px-4">
              ...
              <input
                ...
                className="w-full pl-6 sm:pl-7 pr-3 py-3 sm:py-4 bg-transparent text-xs sm:text-sm text-white placeholder:text-zinc-500 focus:outline-none"
              />
              {keyword && (
                <button
                  type="button"
            ...
            <div className="grid grid-cols-2 sm:flex items-center gap-2 w-full sm:w-auto shrink-0">
              ...
              <div ref={categoryRef} className="relative w-full sm:w-52">
                <button
                  ...
                  className={`w-full bg-zinc-950 rounded-xl sm:rounded-2xl border px-3 sm:px-4 py-3 sm:py-4 text-[11px] sm:text-xs font-semibold text-zinc-200 flex items-center justify-between gap-1.5 sm:gap-2 transition cursor-pointer ${
            ...
            <button
              ...
              className="w-full sm:w-12 sm:h-12 py-3 sm:py-0 bg-[#D4A338] hover:bg-[#b88628] text-black rounded-xl sm:rounded-2xl transition flex items-center justify-center shrink-0 cursor-pointer shadow-md shadow-[#D4A338]/30 gap-2 font-bold text-xs sm:text-base"
            >
        ...
        <div className="pt-0.5 sm:pt-1 flex flex-row items-center justify-center gap-2 sm:gap-3 relative z-10">
          <button
            type="button"
            id="hero-post-brief-btn"
            onClick={() => navigateTo('post-requirement')}
            className="flex-1 sm:flex-none sm:w-auto px-3 sm:px-6 py-2.5 rounded-xl bg-[#D4A338] hover:bg-[#b88628] text-black font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-[#D4A338]/25 transition cursor-pointer"
          >
