...
export const CreatorCard: React.FC<CreatorCardProps> = ({ creator, variant = 'grid' }) => {
  ...
  const getFollowerBadge = (count?: number) => {
    ...
    return { label: 'Icon', style: 'bg-fuchsia-600/80 border-fuchsia-400/50 text-fuchsia-100' }; // 1M+
  };
  ...
  return (
    ...
    >
      ...
      {/* 3. Bottom Essential Information */}
