        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-semibold text-slate-600">
            ...
            <button
              ...
              className="hover:text-[#D4A338] transition flex items-center gap-1.5 py-1 cursor-pointer"
            >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 px-4 py-3 space-y-2 animate-fadeIn text-xs font-medium">
          ...
          <button
            ...
            className="w-full p-2.5 bg-slate-50 text-[#8e6819] rounded-lg text-left flex items-center gap-2"
          >
