...
export async function runAutoMigrations() {
  ...
  try {
    ...
    const alterQueries = [
      ...
      `ALTER TABLE brand_profiles ADD COLUMN logo_url VARCHAR(500) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN cover_url VARCHAR(500) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN description TEXT DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN website VARCHAR(255) DEFAULT NULL`,
      ...
      `ALTER TABLE brand_profiles ADD COLUMN industry VARCHAR(100) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN city VARCHAR(80) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN contact_person VARCHAR(120) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN phone VARCHAR(20) DEFAULT NULL`,
      `ALTER TABLE brand_profiles ADD COLUMN email VARCHAR(150) DEFAULT NULL`,
