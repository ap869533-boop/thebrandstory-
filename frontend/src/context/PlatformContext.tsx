...
export const PlatformProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const registerCreator = (newCreatorData: Partial<Creator>): Creator => {
    ...
    const completeCreator: Creator = {
      ...
      avatar: newCreatorData.avatar || '',
      coverImage: newCreatorData.coverImage || '',
      bio: newCreatorData.bio || '',
      currentCity: newCreatorData.currentCity || '',
      state: newCreatorData.state || '',
      preferredCities: newCreatorData.preferredCities || [],
      primaryCategory: newCreatorData.primaryCategory || '',
      subCategories: newCreatorData.subCategories || [],
      languages: newCreatorData.languages || [],
      ...
      brandCollaborationsCount: newCreatorData.brandCollaborationsCount || 0,
      trustScore: 0,
      trustSignals: {
        profileCompleteness: 0,
        phoneVerified: Boolean(newCreatorData.phone),
        emailVerified: Boolean(newCreatorData.email),
      ...
      isTrending: false,
      status: 'pending',
      startingPrice: newCreatorData.startingPrice || 0,
      ...
      reviews: [],
      phone: newCreatorData.phone || '',
      email: newCreatorData.email || '',
