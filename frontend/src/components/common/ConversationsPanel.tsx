      ...
      <section className="md:col-span-8 flex flex-col min-h-[360px]">
        ...
        {active && (
          <>
            ...
            <form onSubmit={submitReview} className="px-4 pb-4 space-y-2 border-t border-slate-100 pt-3">
              <p className="text-[11px] font-bold text-slate-700 flex items-center gap-1">
                <Star className="w-3.5 h-3.5 text-[#D4A338]" />
                Review this collaboration
              </p>
              <div className="flex gap-2 items-center">
                ...
                />
                <button type="submit" className="px-3 py-1.5 bg-slate-900 text-white rounded-lg text-[11px] font-bold">
                  Submit
                </button>
              </div>
              {reviewMsg && <p className="text-[11px] text-slate-500">{reviewMsg}</p>}
            </form>
          </>
        )}
      </section>
